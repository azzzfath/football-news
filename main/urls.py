...
from main.views import add_news_entry_ajax, delete_news, edit_news, logout_user, show_main, create_news, show_news, show_xml, show_json, show_xml_by_id, show_json_by_id, register, login_user
